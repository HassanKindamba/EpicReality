...
<div class="container my-5">
        ...
        <div class="col-md-5">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <a href="{{ route('agent.properties.index') }}" class="btn btn-outline-secondary w-100">
                        Back to Listings
                    </a>
    ...
    <div class="mt-5">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="{{ route('agent.bedrooms.create', $property->id) }}"
    ...
    <div class="mt-5">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="{{ route('agent.bathrooms.create', $property->id) }}"
               class="btn btn-primary btn-sm">
                Add Bathroom
            </a>
        </div>
