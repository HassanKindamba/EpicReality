...
class AgentBedroomController extends Controller
{
    // Show create form
    public function create($property_id)
    {
        ...
        return view('agent.bedrooms.create', compact('property'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('agent.properties.show', $request->property_id)
    ...
    public function destroy($id)
    {
        ...
        return redirect()
            ->route('agent.properties.show', $property_id)
